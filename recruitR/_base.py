...
class Endpoint:
    ...
    def get_request_url(self):
        return self.api_response.get_url()

    def get_available_data(self):
        return self.get_normalized_dict().keys()

    def get_response(self):
        return self.api_response.get_response()

    def get_dict(self):
        return self.api_response.get_dict()

    def get_json(self):
        return self.api_response.get_json()

    def get_normalized_dict(self):
        return self.api_response.get_normalized_dict()

    def get_normalized_json(self):
        return self.api_response.get_normalized_json()
